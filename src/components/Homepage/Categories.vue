...
<template>
   <div class="container px-4 mx-auto my-16 md:px-12" id="category">
      ...
      <div class="flex flex-wrap -mx-1 lg:-mx-4">
         <CategoriesCard v-for="category in categories.slice(0, 4)" :key="category.id" :id="category.id" :title="category.name" :count="category.products_count" :image="category.thumbnails" />
      </div>
   </div>
</template>
